  ...
  <nav class="main-header navbar navbar-expand bg-white navbar-light border-bottom">
    ...
    <div class="card">
            ...
            <div class="content-wrapper">
              ...
              <div class="form-group">
                <input type="text" name="clave"  class="form-control" placeholder="Password Usuario"/>
              </div>
              <input type="submit" name="grabar_usuario" class="btn btn-success btn-block" value="Grabar Usuario">
            </form>
